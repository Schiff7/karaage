...
import { Nav, Post, Content, Categories, Tags, Demos, About, NoMatch, Loading } from './frames';
...
const Machine = () => {
  ...
  const [record, setRecord]: [Record, (record: Record) => void] = useState({
    ...
    frames: [
      ...
      { key: 'frame-demos',path: '/demos', exact: true, component: Demos, from: 'right', show: false },
